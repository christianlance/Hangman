...
mediumbtn.addEventListener("click", function(){
    ...
    mediumRequest.open('GET', 'https://hangman-micro-service-bpblrjerwh.now.sh/?difficulty=easy')
...
hardbtn.addEventListener("click", function(){
    ...
    hardRequest.open('GET', 'https://hangman-micro-service-bpblrjerwh.now.sh/?difficulty=easy')
